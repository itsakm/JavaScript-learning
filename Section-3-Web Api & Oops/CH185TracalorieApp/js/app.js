class CalorieTracker{
    ...
    _displayCaloriesTotal()
    {
        ...
        totalCalorieEl.innerHTML = this._totalCalorie;
    }
    ...
    _displayRemainingCalories()
    {
        ...
        const remainingCalories = this._calorieLimit - this._totalCalorie;

        remainingCaloriesEl.innerHTML = remainingCalories;

        if(remainingCalories <= 0)
        {
            remainingCaloriesEl.parentElement.parentElement.classList.remove('bg-light');
            remainingCaloriesEl.parentElement.parentElement.classList.add('bg-danger');
            progressEl.classList.remove('bg-success');
            progressEl.classList.add('bg-danger');

        }else{
            remainingCaloriesEl.parentElement.parentElement.classList.remove('bg-danger');
    ...
    _displayCaloriesProgress()
    {
        ...
        const progressH1El = document.querySelector('#progress-percentage');
        progressH1El.innerHTML =`${width}%`;
